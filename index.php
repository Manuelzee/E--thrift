...
<html lang="en">
  ...
  <body class="bg-blue">
    ...
    <ul class="nav justify-content-center fixed-bottom text-muted bg-super-dark">
      <li class="nav-item">
        <a class="nav-link footer-donate cu-po" data-coin-id="bitcoin" data-toggle="modal" data-target="#donateModal">BUY BTC</a>
      </li>
      <li class="nav-item">
        <a class="nav-link footer-donate cu-po" data-coin-id="ethereum" data-toggle="modal" data-target="#donateModal">BUY ETH</a>
      </li>
      <li class="nav-item">
        <a class="nav-link footer-donate cu-po" data-coin-id="litecoin" data-toggle="modal" data-target="#donateModal">BUY LTC</a>
      </li>
    </ul>
    <!-- End of footer -->
