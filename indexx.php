...
<body id="page-top">
    <div id="wrapper">
        ...
        data-aos="flip-down" data-aos-duration="50" data-aos-delay="100" style="background: var(--bs-dark);">
            <div class="container-fluid d-flex flex-column p-0">
                <a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="#">
                    <div class="sidebar-brand-icon rotate-n-13">
                        <img class src =""></i></div>
                    <div class="sidebar-brand-text mx-1"><span>Online Thrift</span></div>
                </a>
                <hr class="sidebar-divider my-0"><ul id="accordionSidebar" class="navbar-nav text-light" 
                style="color: black;">
    <li class="nav-item"><a class="nav-link active" href="indexx.php">
    ...
    <li class="nav-item"><a class="nav-link" href="login.html"><i class="far fa-user-circle">
    </i><span>Log Out</span>
</a>
</li>
    <li class="nav-item"><a class="nav-link" href="referral.html"><i class="fas fa-user-circle">
    </i><span>Referral</span>
</a>
    <li class="nav-item"><a class="nav-link" href="index.php"><i class="fas fa-money-bill">
    </i><span>Crypto</span>
</a>
    </li>
</ul>
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content"><nav class="navbar navbar-light navbar-expand bg-black shadow mb-4 topbar static-top">
    <div class="container-fluid"><button id="sidebarToggleTop" class="btn btn-link d-md-none rounded-circle me-3" type="button"><i class="fas fa-bars"></i></button>
        ...
        <ul class="navbar-nav flex-nowrap ms-auto">
            ...
            <li class="nav-item dropdown no-arrow">
                <div class="nav-item dropdown no-arrow"><a class="dropdown-toggle nav-link" aria-expanded="false" data-bs-toggle="dropdown" href="#"><span class="d-none d-lg-inline me-2 text-gray-600 small">Emmanuel</span>
                    <img class="border rounded-circle img-profile" src="assets/img/avatars/avatar9.jpg" /></a>
                ...
                <div class="container-fluid">
                    <div class="d-sm-flex justify-content-between align-items-center mb-4">
                        <h3 class="text-dark mb-0">Dashboard</h3><a class="btn btn-primary btn-sm d-none d-sm-inline-block" role="button" href="#"><i class="fas fa-download fa-sm text-white-50"></i>&nbsp;Thrift Report</a>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-md-6 col-xl-3 mb-4">
                            <div class="card shadow border-start-info py-2">
                                <div class="card-body">
                                    <div class="row align-items-center no-gutters">
                                        <div class="col me-2">
                                            <div class="text-uppercase text-info fw-bold text-xs mb-1"><span>Tasks on thrift</span></div>
                        ...
                        <div class="col-md-6 col-xl-3 mb-4">
                            <div class="card shadow border-start-warning py-2">
                                <div class="card-body">
                                    <div class="row align-items-center no-gutters">
                                        <div class="col me-2">
                                            <div class="text-uppercase text-warning fw-bold text-xs mb-1"><span>Pending FEES</span></div>
                    ...
                    <div class="row">
                        <div class="col-lg-6 mb-4">
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <h4 class="small fw-bold">Debt<span class="float-end">20%</span></h4>
                                    <div class="progress mb-4">
                                        <div class="progress-bar bg-danger" aria-valuenow="20" aria-valuemin="0" aria-valuemax="100" style="width: 20%;"><span class="visually-hidden">20%</span></div>
                                    </div>
                                    <h4 class="small fw-bold">Activeness<span class="float-end">40%</span></h4>
                                    <div class="progress mb-4">
                                        <div class="progress-bar bg-warning" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100" style="width: 40%;"><span class="visually-hidden">40%</span></div>
                                    </div>
                                    <h4 class="small fw-bold">Referrals<span class="float-end">60%</span></h4>
                                    <div class="progress mb-4">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="text-primary fw-bold m-0">Payment Alerts</h6>
                                </div>
                                <ul class="list-group list-group-flush">
                                    <li class="list-group-item">
                                        <div class="row align-items-center no-gutters">
                                            <div class="col me-2">
                                                <h6 class="mb-0"><strong>Payment by 10:00</strong></h6><span class="text-xs">10:30 AM</span>
                                            </div>
                                            <div class="col-auto">
                                    ...
                                    <li class="list-group-item">
                                        <div class="row align-items-center no-gutters">
                                            <div class="col me-2">
                                                <h6 class="mb-0"><strong>Payment by 11:00</strong></h6><span class="text-xs">11:30 AM</span>
                                            </div>
                                            <div class="col-auto">
                                    ...
                                    <li class="list-group-item">
                                        <div class="row align-items-center no-gutters">
                                            <div class="col me-2">
                                                <h6 class="mb-0"><strong>Payment by 12:00</strong></h6><span class="text-xs">12:30 AM</span>
                                            </div>
                                            <div class="col-auto">
            ...
            <footer class="bg-white sticky-footer">
                <div class="container my-auto">
                    <div class="text-center my-auto copyright"><span>Copyright © Thrift 2022</span></div>
                </div>
            </footer>
